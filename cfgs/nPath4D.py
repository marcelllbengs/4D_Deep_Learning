...
def init(mdlParams):
    ...
    mdlParams['init_kernel'] = (3,3,3,3) # was 7,7 before
    mdlParams['init_stride'] = (1,1,1,1)    
    ...
    mdlParams['t_downsample'] = 1 # in transition layer of densenet
    mdlParams['t_downsample_kernel'] = 1
    
    ########################### Select Data  ###########################
    mdlParams['Data_Type'] = '4D'
    mdlParams['Temporal_Window'] = 5
    ...
    mdlParams['training_steps']  = 140

    # Initial learning rate
    mdlParams['learning_rate'] = 0.001
