...
def init(mdlParams):
    ...
    mdlParams['numOut'] = 3
    mdlParams['spatial_dims'] = '4D' # use 4D network
    ...
    mdlParams['init_kernel'] = (3,3,3,3) # kernel size of the init. conv layer
    mdlParams['init_stride'] = (1,1,1,1) # stride of the init. conv layer
    ...
    mdlParams['Temporal_Window'] = 5 # temporal dimension, i.e., sequence length
